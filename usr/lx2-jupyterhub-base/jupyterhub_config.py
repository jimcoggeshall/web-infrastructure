...
#  through the API.
#c.JupyterHub.load_groups = {'jupyterhub': ['user']}
...
c.Authenticator.admin_users = set(["user"])
...
#  
#  .. versionadded: 0.9
c.Authenticator.blacklist = set(["root", "jovyan"])
...
#  
#  If empty, does not perform any additional restriction.
#c.Authenticator.whitelist = set(["user"])
